...
class CategoryAdmin(BaseModelAdmin):
    ...
    readonly_fields = ('created_at', 'updated_at', 'deleted_at', 'active_products_count')
    ...
    fieldsets = (
        ...
        ('Metadatos', {
            'fields': ('created_at', 'updated_at', 'deleted_at', 'active_products_count'),
            'classes': ('collapse',)
        })
    )
    ...
    def activate_categories(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{updated} categorías activadas exitosamente.'
        )
    ...
    def deactivate_categories(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{updated} categorías desactivadas exitosamente.'
        )
...
class ProductAdmin(BaseModelAdmin):
    ...
    fieldsets = (
        ...
        ('Características', {
            'fields': ('size', 'color', 'barcode')
        }),
        ('Precios e Inventario', {
            'fields': ('price', 'cost', 'stock', 'min_stock')
        }),
        ('Imagen', {
    ...
    def activate_products(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{updated} productos activados exitosamente.'
        )
    ...
    def deactivate_products(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{updated} productos desactivados exitosamente.'
        )
    ...
    def mark_as_low_stock(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{count} productos identificados con stock bajo.'
        )
    ...
    def bulk_update_stock(self, request, queryset):
        ...
        return format_html(
            '<script>alert("Funcionalidad de actualización masiva en desarrollo. IDs seleccionados: {}");</script>',
            list(selected)
        )
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        if db_field.name == "category":
            kwargs["queryset"] = Category.objects.filter(is_active=True, is_deleted=False)
