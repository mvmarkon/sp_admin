...
class CategorySerializerTest(TestCase):
    ...
    def test_category_serializer_invalid_data(self):
        ...
        invalid_data = {"name": "", "description": "Descripción válida"}  # Nombre vacío
...
class ProductSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(
            name="Camisetas", description="Camisetas para niños"
        )
...
class ProductStockUpdateSerializerTest(TestCase):
    ...
    def test_stock_update_serializer_valid_data(self):
        ...
        serializer = ProductStockUpdateSerializer(
            data=update_data, context={"product": self.product}
        )
    ...
    def test_stock_update_serializer_invalid_quantity(self):
        ...
        update_data = {"quantity": 0, "operation": "add"}  # Cantidad inválida
...
class CategoryAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.category1 = Category.objects.create(
            name="Camisetas", description="Camisetas para niños", is_active=True
        )

        self.category2 = Category.objects.create(
            name="Pantalones", description="Pantalones para niños", is_active=True
        )
    ...
    def test_create_category_unauthenticated(self):
        ...
        url = "/api/categories/"
        data = {"name": "Zapatos", "description": "Zapatos para niños"}
...
class ProductAPITest(APITestCase):
    ...
    def test_update_product_stock(self):
        ...
        data = {"quantity": 10, "operation": "add", "reason": "Test de actualización"}
