...
urlpatterns = [
    ...
    # Gestión de stock
    path('products/<str:sku>/update-stock/', views.update_product_stock, name='product-update-stock'),
    path('products/bulk-update/', views.bulk_update_products, name='product-bulk-update'),
    
    # Consultas especiales
    path('products/alerts/low-stock/', views.low_stock_products, name='low-stock-products'),
    path('products/alerts/out-of-stock/', views.out_of_stock_products, name='out-of-stock-products'),
