...
WSGI_APPLICATION = "sp_admin.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SanPedrito Inventory API",
    "DESCRIPTION": "API REST para gestión de inventario de tienda infantil SanPedrito",
    "VERSION": "1.0.0",
